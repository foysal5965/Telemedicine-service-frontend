...
import { getTimeIn12HourFormat } from '@/app/(withDashboradLayout)/dashboard/doctor/schedules/components/MultipleSelectFieldChip';
import { useCreateAppointmentMutation } from '@/redux/api/appointmentApi';
import { useGetAllDoctorSchedulesQuery, useGetAvailableDoctorSchedulesQuery } from '@/redux/api/doctorScheduleApi';
...
const DoctorScheduleSlots = ({ id }: { id: string }) => {
   ...
   const { data, isLoading } = useGetAvailableDoctorSchedulesQuery({ ...query });
   //@ts-ignore
